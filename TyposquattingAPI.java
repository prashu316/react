...
public class TyposquattingAPI extends ApiImplementor {
    protected static final String PREFIX = "Typosquatting";

    private static final String NAME = "ExtensionTyposquatting";

    private static final String ACTION_HELLO_WORLD = "helloWorld";

    private static final Logger LOGGER = LogManager.getLogger(TyposquattingAPI.class);

    public TyposquattingAPI() {
